    ...
    if (id) {
      api.get(`/products/${id}`)
        .then((res) => {
          ...
          setValue('price', data.price !== null && data.price !== undefined ? Number(data.price) : 0);
          setValue('salePrice', data.salePrice !== null && data.salePrice !== undefined ? Number(data.salePrice) : null);
          setValue('stock', data.stock !== null && data.stock !== undefined ? Number(data.stock) : 0);
          setValue('stockStatus', data.stockStatus || undefined);
          setValue('weight', data.weight !== null && data.weight !== undefined ? Number(data.weight) : null);
          setValue('isActive', data.isActive ?? true);
          setValue('isFeatured', data.isFeatured ?? false);
          setValue('sortOrder', data.sortOrder !== null && data.sortOrder !== undefined ? Number(data.sortOrder) : 0);
