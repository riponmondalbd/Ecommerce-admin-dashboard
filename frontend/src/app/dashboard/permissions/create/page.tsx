  ...
  return (
    <div className="p-8 min-h-full">
      <div className="max-w-3xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Create New Permission</h1>
          <p className="text-gray-600">Define a new permission with key, name, and group</p>
        </div>
