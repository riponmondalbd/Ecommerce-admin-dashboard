...
export const attributeRoutes = (app: Express) => {
  ...
  app.get('/api/attributes', authenticate, requirePermission('attribute:read'), listAttributes);

  // GET /api/attributes/:id - Get single attribute by ID (requires permission: attribute:read)
  app.get('/api/attributes/:id', authenticate, requirePermission('attribute:read'), getAttribute);

  // POST /api/attributes - Create new attribute (requires permission: attribute:create)
  app.post('/api/attributes', authenticate, requirePermission('attribute:create'), createAttributeController);

  // PUT /api/attributes/:id - Full update of attribute (requires permission: attribute:update)
  app.put('/api/attributes/:id', authenticate, requirePermission('attribute:update'), updateAttributeController);

  // PATCH /api/attributes/:id - Partial update of attribute (requires permission: attribute:update)
  app.patch('/api/attributes/:id', authenticate, requirePermission('attribute:update'), partialUpdateAttributeController);

  // DELETE /api/attributes/:id - Delete attribute (requires permission: attribute:delete)
  app.delete('/api/attributes/:id', authenticate, requirePermission('attribute:delete'), deleteAttributeController);

  // GET /api/attributes/:attributeId/values - Get values for an attribute (requires permission: attribute:read)
  app.get('/api/attributes/:attributeId/values', authenticate, requirePermission('attribute:read'), getAttributeValuesController);

  // POST /api/attributes/:attributeId/values - Create new value (requires permission: attribute:update)
  app.post('/api/attributes/:attributeId/values', authenticate, requirePermission('attribute:update'), createAttributeValueController);

  // PUT /api/attribute-values/:id - Full update of attribute value (requires permission: attribute:update)
  app.put('/api/attribute-values/:id', authenticate, requirePermission('attribute:update'), updateAttributeValueController);

  // PATCH /api/attribute-values/:id - Partial update of attribute value (requires permission: attribute:update)
  app.patch('/api/attribute-values/:id', authenticate, requirePermission('attribute:update'), partialUpdateAttributeValueController);

  // DELETE /api/attribute-values/:id - Delete attribute value (requires permission: attribute:delete)
  app.delete('/api/attribute-values/:id', authenticate, requirePermission('attribute:delete'), deleteAttributeValueController);
};
